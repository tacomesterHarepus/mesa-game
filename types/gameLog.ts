// game_log types — see PHASE_11_METADATA_SCHEMA.md for field-level documentation.
...
export interface GameLogEntry<T extends GameLogEventType = GameLogEventType>
  extends GameLogInsert<T> {
  id: string;
  created_at: string;
}
